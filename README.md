...
license-review preflight without exposing either candidate review; the report
checks the hash-bound task, schema, guide, and one review file but cannot grant
permission or establish legal authority.
