...
- [ ] P0-8. AGB-001 live full-run validation. Live TUI run attempted on 2026-05-02; `LV-320`, `LV-321`, `LV-322`, `LV-323`, and `LV-324` repairs are implemented and pass automated validation, but P0-8 remains blocked pending rebuilt same-flow live revalidation.
...
- [ ] Status: attempted on 2026-05-02; `LV-320`, `LV-321`, `LV-322`, `LV-323`, and `LV-324` repairs implemented and automated validations pass; still blocked pending rebuilt same-flow live revalidation
- Related repo files:
  - Existing: `src/cli/args.ts`
  - Existing: `src/cli/main.ts`
  - Existing: `src/app.ts`
...
- Planned files if needed:
  - Same-flow revalidation notes after `LV-321`, `LV-322`, `LV-323`, and `LV-324` repairs
- Validation commands:
  - `npm run build`
  - `npm test`
  - `npm run validate:harness`
...
- Validation notes:
  ...
  - `LV-321`, `LV-322`, `LV-323`, and `LV-324` repairs pass targeted regressions, full build, full test suite, and harness validation. Same-flow live TUI revalidation is still required before checking P0-8.
- Completion criteria:
