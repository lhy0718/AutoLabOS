...
Plans must declare the paper-scale evidence floor: independent evaluation units, repetition or cluster counts when stochasticity exists, baseline/comparator, execution budget, raw-denominator reporting, and statistical/uncertainty method.
...
For interaction claims, require an identified design with a declared interaction estimand, adequate independent-unit coverage, and an uncertainty or robustness procedure appropriate to the stochastic or deterministic design.
