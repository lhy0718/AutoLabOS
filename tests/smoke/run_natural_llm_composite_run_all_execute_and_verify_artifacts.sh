...
smoke_set_fake_semantic_scholar_fixture "llm-composite-all" "LLM Composite All Paper"

smoke_run_expect "natural_llm_composite_run_all_execute_and_verify_artifacts.exp" "$RUN_ID"
smoke_verify_collect_artifacts "$RUN_DIR" "$(smoke_bib_key_for_prefix "llm-composite-all")" "3" "true" "" "llm composite-all"
