...
export const SLASH_COMMANDS: SlashCommandDef[] = [
  ...
  { name: "brief", usage: "/brief start <path|--latest>", description: "Start research from Brief.md or a brief path", category: "workflow", argHint: "start <path|--latest>", visible: true },
  {
    ...
    description: "Run environment checks; optionally send one live compatibility request",
    category: "system",
  ...
  { name: "analyze-results", usage: "/analyze-results [run]", description: "Inspect analyze_results and review readiness for a run", category: "run", argHint: "[run]", visible: true, preserveDraftOnRun: true },
  ...
  { name: "artifact", usage: "/artifact <path> [--run <run>]", description: "Preview a run artifact or list manuscript-quality artifact shortcuts", category: "session", argHint: "<path>", visible: true, preserveDraftOnRun: true },
