...
- `CLAIM_NOT_CHECKED` `schmidgall-etal-2025-agent`: Claim claim-0001 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `starace2025paperbench`: Claim claim-0002 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `jiang-etal-2026-badscientist`: Claim claim-0003 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `dycke-gurevych-2026-automatic`: Claim claim-0004 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `schmidgall-etal-2025-agent`: Claim claim-0005 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `starace2025paperbench`: Claim claim-0006 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `jiang-etal-2026-badscientist`: Claim claim-0007 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `dycke-gurevych-2026-automatic`: Claim claim-0008 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `javaji-etal-2025-ai`: Claim claim-0009 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `riehl2026ara`: Claim claim-0010 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `hu2025reprobench`: Claim claim-0011 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `petel2026madscps`: Claim claim-0012 is marked claim_unchecked.
- `CLAIM_NOT_CHECKED` `ma2026reflection`: Claim claim-0013 is marked claim_unchecked.
