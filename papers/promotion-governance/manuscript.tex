...
bundles and 200 held-out cases, with 30 base bundles preferred. Two reviewers
must adjudicate held-out promotion labels, and separate reviewers must verify
mutation isolation without access to system predictions. Pseudonymous IDs
enforce record-level role separation but do not prove real-world identity, so
an external assignment log is also required. The manuscript-only
