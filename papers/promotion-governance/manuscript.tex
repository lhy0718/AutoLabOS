...
introduces only its declared fault. Because promotion-label reviewers are blind
to mutation metadata, mutation-isolation verification requires a separate
auditor role and remains a confirmatory-readiness requirement.
...
mutation isolation without access to system predictions. The manuscript-only
